...
ggplot(plot_data,
  ...
  labs(
    ...
    y = "Race/Ethnic Group",
    title = "Climate Hazard Risk Exposure by Ethnic Group in California",
    subtitle = "Population-weighted composite scores show differences in average climate hazard exposure\n across racial and ethnic groups. The solid line indicates the statewide average"
  ) +
  
  annotate("text", x = 98.94, y = "Black or African American", 
           label = "Statewide\nAverage\n(~98.99)") +
